             ...
             <div className="space-y-8">
                 <div className="border-b border-slate-100 pb-6">
                    <h2 className="text-2xl font-bold text-slate-900 mb-2 flex items-center gap-3">
                        Component Restoration (v47)
                    </h2>
                    <p className="text-slate-600">
                        Download the full source code package to restore your missing components folder.
                    </p>
                </div>
                ...
                <div className="bg-blue-50 border-2 border-blue-200 p-8 rounded-xl shadow-lg">
                     <h3 className="font-bold text-blue-800 mb-4 flex items-center gap-2 text-xl">
                        <ShieldCheck size={24} /> Full Restoration Package
                    </h3>
                    <p className="text-sm text-blue-700 mb-6">
                        This package contains the complete <code>src/components</code> directory with all 22 required files, plus services and constants.
                    </p>
                    
                    <div className="bg-white p-4 rounded-lg border-l-4 border-blue-500 shadow-sm mb-6">
                        <p className="text-sm text-blue-600 font-bold flex items-center gap-2 mb-1">
                            <AlertTriangle size={16}/> INSTRUCTIONS
                        </p>
                        <div className="text-xs text-slate-600 mt-1 leading-relaxed space-y-2">
                            <p><strong>1. Download the ZIP file below.</strong></p>
                            <p><strong>2. Delete the current contents of your GitHub repository.</strong></p>
                            <p><strong>3. Upload the contents of the ZIP file.</strong></p>
                            <p><strong>4. Commit and Push.</strong> Vercel will rebuild successfully.</p>
                        </div>
                    </div>
                    ...
                    >
                        {isZipping ? (
                            <><Loader2 size={24} className="animate-spin"/> Packaging Files...</>
                        ) : (
                            <><Rocket size={24} /> Download Recovery Zip (v47)</>
                        )}
                    </button>
                </div>
            </div>
